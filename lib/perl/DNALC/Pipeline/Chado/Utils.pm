...
sub create_chado_config {
    ...
    #get gmod config and db info
    my $gmod_conf = Bio::GMOD::Config->new();
    my $db_conf   = Bio::GMOD::DB::Config->new( $gmod_conf,$conffile);
    ...
    if ($count >= 30) {
        print "Unfortunately, the server is either really busy or broken.  Please come back later";
        exit(0);
    }

    #create chado-adapter.xml
    open CA, ">/var/www/.apollo/chado-adapter.xml";
    print CA <<END;
<?xml version="1.0" encoding="UTF-8"?>
<!-- This file is used to config chado database adapter -->
<!-- it is automatically generated by apollo_request_region.pl -->
<chado-adapter>
